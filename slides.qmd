...
format:
  revealjs:
    ...
    preview-links: auto
---
## About me {background-color="black"}
...
## Evolution {visibility="hidden"}

![](img/machineLearningEVO.png){fig-align="center"}

[by Artificial Intelligence: Linkedin, Machine Learning vs Deep learning]{style="font-size: 20px;"}
...
[by [Scott Fortmann-Roe, 2012](https://scott.fortmann-roe.com/docs/BiasVariance.html)]{style="font-size: 20px;"}

:::
::: {.column width="50%"}
![](img/modelComplexity.png){fig-align="center"}

[by [Satya Mallick, 2021](https://learnopencv.com/bias-variance-tradeoff-in-machine-learning/)]{style="font-size: 20px;"}
...
[By [synergy37AI](https://medium.com/@synergy37AI), in Medium: [Decision Trees: Lesson 101](https://medium.datadriveninvestor.com/decision-trees-lesson-101-f00dad6cba21)]{style="font-size: 20px;"}

## Random Forest
![](img/randomForest.jpg){fig-align="center"}

[By [Tony Yiu](https://tonester524.medium.com/), in Medium: [Understanding Random Forest](https://towardsdatascience.com/understanding-random-forest-58381e0602d2)]{style="font-size: 20px;"}

## K Nearest Neighbors (KNN)

![](img/knn.jpg){fig-align="center"}

[Note: Small K can generate overfitting (learns from noise), large K can generate underfitting (neighbors too far away).]{style="font-size: 20px;"}
...
# Hands-on {background-color="black"}
...
[\@tamagusko](https://www.linkedin.com/in/tamagusko/) on LinkedIn to stay in touch!
...
- [github.com/tamagusko/workshop-intro-ml](https://github.com/tamagusko/workshop-intro-ml)

or

- [bit.ly/workshop-intro-ml](https://bit.ly/workshop-intro-ml)
