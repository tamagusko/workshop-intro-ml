...
- Hands-on 1: Traditional vs Machine learning (15 minutes)
- Break: 10 minutes
- Hands-on 2: Practical example (30 minutes)
...
:::
::: {.column width="63%"}
```{.python code-line-numbers="2,3,6,9,13,17"}
import pandas as pd
...
## Evolution {.smaller visibility="hidden"}
